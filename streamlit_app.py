ฉันได้จัดรูปแบบโค้ด Python ที่คุณให้มาแล้ว โดยจัดกลุ่มฟังก์ชันและส่วนต่าง ๆ ให้เป็นระเบียบมากขึ้น พร้อมกับใช้เครื่องหมาย `---` เพื่อแบ่งส่วนหลัก ๆ ของ Streamlit app:
